// Note: I copy-pasted this from fillout.com to mimic the UI better, nothing fancy here.
export default function Sidebar() {
  return (
    <div className="flex w-[226px] flex-shrink-0 overflow-hidden border-x-[0.5px] border-gray-300 bg-gray-50 duration-200 lg:w-[300px]">
      <div className="flex w-[226px] flex-shrink-0 lg:w-[300px]">
        <div className="flex h-full w-full max-w-[226px] min-w-[180px] flex-col justify-between lg:max-w-[300px] lg:min-w-[270px]">
          <div className="flex h-full flex-col justify-start overflow-auto pt-4">
            <div className="z-10 flex items-center border-b border-transparent bg-gray-50 px-3 pb-[10px] transition duration-200">
              <div className="file:text-foreground placeholder:text-muted-foreground relative flex h-min w-full items-center rounded-lg border border-[rgba(0,0,0,0.11)] bg-transparent shadow-sm transition file:border-0 file:bg-transparent file:font-medium focus-within:border-blue-400 focus-within:ring-2 focus-within:ring-blue-200 focus-within:outline-none disabled:cursor-not-allowed disabled:opacity-50">
                <div className="pointer-events-none absolute left-2 flex h-4 w-4 items-center justify-center text-gray-500 [&:has(button)]:pointer-events-auto [&>svg]:h-4 [&>svg]:w-4">
                  <svg
                ...
                <input
                  className="h-9 w-full rounded-lg border-0 px-3 py-2 pl-7 text-sm focus:ring-0 focus:outline-none disabled:opacity-50"
            ...
            <div
              dir="ltr"
              className="relative mr-px overflow-hidden"
              id="widgets"
                ...
                <div style={{ minWidth: "100%", display: "table" }}>
                  ...
                  <div className="px-4">
                    <div>
                      ...
                      <div className="mt-3 grid grid-cols-2 gap-2 gap-y-4 lg:grid-cols-3">
                        <button
                          type="button"
                          className="flex w-full cursor-pointer flex-col items-center rounded-md border border-white bg-white px-[3px] pt-3 pb-[6px] shadow hover:shadow-md hover:shadow-gray-400/50"
                        >
                          <div
                          ...
                          <div className="mt-2 flex h-6 items-center justify-center text-center text-xs leading-3 font-medium text-gray-700">
                            Short answer
                          </div>
                        </button>
                        <button
                  ...
                  <div className="my-5 space-y-3 px-4">
                    ...
                    <button
                      type="button"
                      className="inline-flex h-[42px] items-center rounded-md border border-gray-300 bg-white px-3 text-sm leading-4 font-medium text-gray-500 shadow-sm hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:outline-none sm:h-[38px]"
                    >
                      <span className="mr-3 rounded-md border border-purple-200 bg-purple-100 p-1 text-purple-500">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                    ...
                    >
                      <span
                        className="mr-2 rounded-md border-[0.5px] p-1"
                        style={{
                          background: "rgb(253, 242, 248)",
                          color: "rgb(236, 72, 153)",
